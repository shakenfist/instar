...
refcount order, virtual size, grain size, dual headers, BAT entries). Images
live in `../imago-testdata/custom/audit/`. See `PLAN-adversarial-images.md`
for the full adversarial testing strategy.
