...
0. Read the contents of AGENTS.md, ARCHITECTURE.md, and docs/ to
   gather context. This is a security focused project, so you **must**
   assume this code will operate on actively malicious input data and
   raise any security concerns you find.
