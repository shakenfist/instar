...
//!
//! Implements a virtio-block device backed by a file.
...
impl VirtioBlockDevice {
    pub fn new(file: File, size_bytes: u64, read_only: bool, mmio_base: u64, vq_base: u64) -> Self {
        Self {
            file,
    ...
    pub fn process_queue(
        ...
        while last_avail_idx != avail.idx {
            ...
            let bytes_written = self.process_request(guest_mem, desc_addr, desc_idx, queue_size)?;
    ...
    /// Read from file to guest memory
    fn do_read(
        &mut self,
        guest_mem: &GuestMemoryMmap,
        sector: u64,
