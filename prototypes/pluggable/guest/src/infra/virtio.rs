//! Virtio block device abstraction for the bare-metal guest.
//!
//! Provides a high-level interface to virtio-block devices, hiding the
//! low-level MMIO register manipulation and virtqueue management.

use core::ptr::{read_volatile, write_volatile};

use super::mem::{DMA_POOL_BASE, MAX_SECTOR_SIZE};
use super::serial::{send_capacity, send_error, send_init};
