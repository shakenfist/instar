...
//!
//! Implements a virtio-block device backed by different storage modes:
//! - Regular file I/O
//! - O_DIRECT (direct I/O bypassing page cache)
//! - Memory-mapped files
...
impl VirtioBlockDevice {
    ...
    /// Get the backing store mode
    #[allow(dead_code)]
    pub fn backing_mode(&self) -> crate::backing::BackingMode {
        self.backing.mode()
    }
