...
| Document | Purpose |
|----------|---------|
| [Reading Order](reading-order.md) | Which files to read, in what sequence, and what to look for in each |
| [Architectural Decisions](architectural-decisions.md) | The *why* behind every major design choice |
