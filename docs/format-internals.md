...
matrix, see [format-coverage.md](format-coverage.md); for user-facing
reference, see [usage.md](usage.md) and the per-operation pages.
...
[docs/create.md](create.md) for the user reference and
[docs/quirks.md](quirks.md) for the documented writer
divergences.
...
[docs/qcow2/qcow2-write-planner.md](qcow2/qcow2-write-planner.md).
...
[docs/format-coverage.md](format-coverage.md) and
[docs/quirks.md](quirks.md) for the full parity and quirks
detail.
...
refusals. See [docs/format-coverage.md](format-coverage.md)
and [docs/quirks.md](quirks.md) for the full parity and
quirks detail.
