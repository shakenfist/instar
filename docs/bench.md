...
[usage.md](usage.md). For the qcow2-write migration quirks, see
[quirks.md](quirks.md).
...
[quirks.md](quirks.md) for the per-operation record, and
[PLAN-differencing.md](plans/PLAN-differencing.md) for the composition
