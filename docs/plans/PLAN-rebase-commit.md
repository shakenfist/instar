...
| 6. Commit planners (qcow2 + vmdk) | [PLAN-rebase-commit-phase-06-commit-planners.md](PLAN-rebase-commit-phase-06-commit-planners.md) | Complete: scaffold (34333e9), qcow2 commit planner + backing allocator (da0b974), vmdk commit planner + grain allocator (db4d389), cross-format integration tests (26ca765). |
| 7. Commit guest binary | [PLAN-rebase-commit-phase-07-commit-guest.md](PLAN-rebase-commit-phase-07-commit-guest.md) | Complete: error codes (0de7e2c), scaffold (b9821bb), qcow2 commit runner (b02d143), vmdk commit runner (db3ed0d). |
| 8. Commit host CLI (`run_commit`, clap args, overlay-RW wiring) | [PLAN-rebase-commit-phase-08-commit-host.md](PLAN-rebase-commit-phase-08-commit-host.md) | Not started |
| 9. Commit integration tests + cross-version baselines | PLAN-rebase-commit-phase-09-commit-tests.md (not yet written) | Not started |
| 10. Coverage-guided fuzzing (rebase + commit planners) | PLAN-rebase-commit-phase-10-fuzz.md (not yet written) | Not started |
| 11. Differential fuzzing vs qemu-img | PLAN-rebase-commit-phase-11-diff-fuzz.md (not yet written) | Not started |
