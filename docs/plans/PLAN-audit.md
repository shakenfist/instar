...
[PLAN-coverage-fuzzing.md](PLAN-coverage-fuzzing.md), which is now
...
| 6. Coverage-guided fuzzing | **Complete** | `audit` | 40 fuzz targets, corpus seeding, nightly CI at a 450-minute tiered budget, automatic issue filing. ~200 `security-audit` issues closed; 1 open defect (#483). Detailed plan: [PLAN-coverage-fuzzing.md](PLAN-coverage-fuzzing.md) |
...
See **[PLAN-coverage-fuzzing.md](PLAN-coverage-fuzzing.md)** for
...
* **Automated fuzzer bug fixes** -- Scheduled CI job that picks
  ...
  [PLAN-fuzz-autofix.md](PLAN-fuzz-autofix.md).
