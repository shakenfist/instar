...
* **Crashes fixed and tracked** — roughly 200 `security-audit` issues
  ...
  work and both completed: [PLAN-fuzzing-bugs.md](PLAN-fuzzing-bugs.md)
  (44 issues, 5 root causes) and [PLAN-bug-fixes.md](PLAN-bug-fixes.md)
...
[PLAN-fuzz-autofix.md](PLAN-fuzz-autofix.md) for automated triage.
