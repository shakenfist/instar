...
[PLAN-bitmap.md](PLAN-bitmap.md); Phases 1–3 are complete
([parse](PLAN-bitmap-phase-01-parse.md),
[ABI](PLAN-bitmap-phase-02-abi.md),
[planner](PLAN-bitmap-phase-03-planner.md)). This is the fourth of
