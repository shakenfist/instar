...
| 10. Differential fuzzing: random corruptions injected into a valid image, repaired by both instar and qemu-img, results compared for `qemu-img check` cleanliness and guest-data equivalence | PLAN-check-repair-phase-10-fuzz-differential.md | **Planned, not started** |
