...
Previous phase: [PLAN-create-phase-10-fuzz-differential.md](PLAN-create-phase-10-fuzz-differential.md)
...
adds `~~create~~ — shipped, see [PLAN-create.md](PLAN-create.md)`.
...
```
- [Create](create.md) — create a new empty disk image
```
