...
| 9. Documentation, CHANGELOG, follow-ups | [PLAN-map-phase-09-docs.md](PLAN-map-phase-09-docs.md) | Complete (docs/map.md authored; cross-document touch-ups landed; PLAN-convert-followups strikethrough applied; master plan / docs/plans/index.md flipped to Complete) |
