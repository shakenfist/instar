...
[PLAN-amend.md](PLAN-amend.md); phases 1–8 are landed (phase 8
...
- **Two parallel command tables** — `docs/index.md` and
  ...
  (rows like `| [Resize](resize.md) | \`instar resize\` - … |`).
