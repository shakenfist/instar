...
[PLAN-bitmap.md](PLAN-bitmap.md); Phase 1 is
[PLAN-bitmap-phase-01-parse.md](PLAN-bitmap-phase-01-parse.md).
This is the second of ten phases. The direct template for this
phase is [PLAN-amend-phase-01-abi.md](PLAN-amend-phase-01-abi.md).
