...
Phase 6 of [PLAN-differencing.md](PLAN-differencing.md).
...
([PLAN-differencing.md](PLAN-differencing.md), "Agent guidance").
...
[PLAN-differencing-phase-01-pin.md](PLAN-differencing-phase-01-pin.md),
...
([PLAN-differencing.md](PLAN-differencing.md), "Execution") is
...
([pin](PLAN-differencing-phase-01-pin.md), "VHDX — which keys
