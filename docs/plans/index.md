...
| 2026-05-09 | [Release v0.2.0](PLAN-release-v0.2.md) | Cut the v0.2.0 tag and publish signed GitHub Release artifacts (tarball, .deb, .rpm) for x86_64 Linux | Drafted, not started | (no phase files; sequential gates) |
