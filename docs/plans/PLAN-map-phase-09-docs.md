...
| File | Change |
|------|--------|
| `docs/index.md` | New row in the "Instar-Specific Features" table: `\| [Map](map.md) \| instar map - emit the allocation map of a disk image \|`. Insert after the existing `Commit` row (line 50). |
