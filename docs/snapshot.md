...
snapshot section of [docs/quirks.md](quirks.md)):
...
see the convert section of [docs/quirks.md](quirks.md), including
...
these behaviours are in [docs/quirks.md](quirks.md).
...
lives in
[docs/qcow2/qcow2-snapshots.md](qcow2/qcow2-snapshots.md)):
...
plan](plans/PLAN-snapshot.md)'s Future work section: compressed
