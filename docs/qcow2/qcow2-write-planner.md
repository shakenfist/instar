...
document builds on, see [qcow2-format.md](qcow2-format.md),
[qcow2-l1l2-tables.md](qcow2-l1l2-tables.md),
[qcow2-refcount.md](qcow2-refcount.md) and
[qcow2-snapshots.md](qcow2-snapshots.md).
...
The per-op behaviour is documented in [commit.md](../commit.md),
[rebase.md](../rebase.md) and [bench.md](../bench.md); this reference
...
- **qemu-parity** (copy-on-write, snapshot-bearing). COW is net-new
  ...
  ["Copy-on-write for snapshot-bearing qcow2 images"](../quirks.md)
...
[PLAN-qcow2-write-infrastructure.md](../plans/PLAN-qcow2-write-infrastructure.md)
...
[PLAN-bench-refcount-growth.md](../plans/PLAN-bench-refcount-growth.md)
