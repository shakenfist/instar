...
[Parallels, Bochs, cloop and DMG detection](quirks.md#parallels-bochs-cloop-and-dmg-detection)
(detection, the #444 detect-only refusal, DMG raw pass-through in the in-place
ops),
[VDI](quirks.md#vdi-convert-from-read-path) (VDI),
[Parallels](quirks.md#parallels-convert-from-read-path)
(Parallels),
[QCOW1](quirks.md#qcow1-convert-from-read-path)
(QCOW1),
[DMG](quirks.md#dmg-convert-from-read-path) (DMG),
and
[QED](quirks.md#qed-read-refusal-as-policy) (QED).
...
cross-tool diff. See [docs/resize.md](resize.md) and the
"resize subcommand quirks" section of [docs/quirks.md](quirks.md).
...
[docs/quirks.md](quirks.md) as a deliberate divergence from
qemu-img.
...
`parentFileNameHint`. See [docs/rebase.md](rebase.md) and
...
too. See [docs/commit.md](commit.md) and the "commit
...
rejected by `qemu-img info`). See [docs/dd.md](dd.md) for the
full reference.
