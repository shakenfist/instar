...
Test images are generated by scripts in `scripts/`:
- `create-compression-bomb-testdata.sh`
- `create-circular-chain-testdata.sh`
- `create-deep-chain-testdata.sh`
- `create-overflow-testdata.sh`
- `create-boundary-testdata.py`
- `create-format-confusion-testdata.py`

All images live in `imago-testdata/custom/audit/`. See `PLAN-adversarial-images.md`
