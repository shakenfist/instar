...
[docs/measure.md](measure.md) for the full reference.
...
[docs/snapshot.md](snapshot.md) for the full reference.
...
[docs/amend.md](amend.md) for the full reference.
...
[docs/dd.md](dd.md) for the full reference.
...
[docs/bitmap.md](bitmap.md) for the full reference.
...
with no confirmation. See [docs/bench.md](bench.md) for the full
reference.
