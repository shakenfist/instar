...
[Architecture](../ARCHITECTURE.md) for how it fits the rest of the tool,
...
- **operations/amend/** - In-place qcow2 header amendment operation
 ...
 [docs/amend.md](amend.md) for the full user reference.
- **operations/dd/** - Windowed block-copy operation (PLAN-dd,
 ...
 [docs/dd.md](dd.md) for the full user reference.
...
- **operations/bench/** - I/O benchmark operation (PLAN-bench), the
 ...
 measurement (see [docs/bench.md](bench.md)). The host side
...
See [docs/chain-config.md](chain-config.md) for the chain config
