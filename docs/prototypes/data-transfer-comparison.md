...
|-----------|----------|-------------------|----------------|
| [Virtio-block](data-transfer-virtio-block.md) | Large files, disk images | Unlimited (64-bit sectors) | Medium |
| [Virtio-vsock](data-transfer-virtio-vsock.md) | Streaming, bidirectional | Unlimited (streaming) | High |
| [Custom MMIO](data-transfer-other.md#custom-mmio-device) | Prototyping, simple I/O | Unlimited (64-bit offset) | Low-Medium |
| [Direct Memory](data-transfer-direct-memory.md) | Small fixed-size data | ~1-2 GB | Low |
| [ioeventfd/irqfd](data-transfer-other.md#ioeventfd--irqfd) | Notifications only | N/A | Low |
...
- [Direct Memory I/O](data-transfer-direct-memory.md)
- [Virtio-vsock](data-transfer-virtio-vsock.md)
- [Virtio-block](data-transfer-virtio-block.md)
- [Other Mechanisms](data-transfer-other.md)
- [KVM API Guide](kvm.md)
