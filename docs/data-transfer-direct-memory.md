...
>
> For disk images in the 10-100+ GB range, use [virtio-block](data-transfer-virtio-block.md)
...
- Large disk images (10s-100s of GB) - use [virtio-block](data-transfer-virtio-block.md)
- Streaming data - use [virtio-vsock](data-transfer-virtio-vsock.md)
